...
```{r}
#<< get symbols of companies (look up table)
company <- read_csv("data/companySG.csv")

#<< sort top 40 and get symbols
Top40 <- company %>% 
...
```{r}
#<< pass in symbols of top 40 companies into tidyquant to get time series dataset
Stock40_daily <- Top40 %>%
...
#### Plotting Interactive Line Chart (using Plotly)
...
```{r}
end <- as_date("2022-03-31") #<< fix the end date
...
#### Interactive Candlesticks Chart (ggplot2 and Plotly method)
