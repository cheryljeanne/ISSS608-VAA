...
```{r}
#<< connect to ODBC directly
#install.packages("RODBC")
#library(RODBC) #need to use 32bit version
...
### Sparklines using gtExtras method
...
Adding Statistics to Sparklines
...
#<< Adding Statistics into Data Table
...
### Change to Sparkbar instead of Sparkline
